...
layout: default
---
{% if site.data.config.cft.url %}
{:.mb-3 .text-white}
# \*** [Click Here to Submit!]({{ site.data.config.cft.url }}) **\*

{:.text-white .text-center}
#### BSidesROC is looking for trainers for our 2026 event.

{:.mt-3 .text-white}
#### IMPORTANT DATES
- CFT Closes: 01/16/2026
- CFT Responses Sent: 02/07/2026
...
{% elsif site.data.config.cft.closed %}
{:.text-white .text-center}
{:.mb-3 .text-white}
# BSidesROC Call For Trainers Closed!
Thank you so much for expressing an interest in being a trainer for BSidesRoc, unfortunately submissions are now closed.
